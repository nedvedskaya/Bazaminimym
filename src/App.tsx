      ...
      <section className="relative py-16 sm:py-20 lg:py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            {[
              { before: "Работа ради работы", after: "Чек +40–100%" },
              { before: "Базовый прайс", after: "Доход х2" },
              { before: "8/10 слив", after: "7/10 запись" },
              { before: "Клиент пропадает", after: "Визит за 30 сек" },
              { before: "−20% скидки", after: "100% прайс" },
              { before: "Страх 300к+", after: "Уверенность 500к+" },
              { before: "Одноразка", after: "Постоянники" },
              ...
              <motion.div
                ...
                className="bg-[#f5f5f5] hover:bg-[#e3ee6b]/30 rounded-full px-3 py-2 sm:px-4 sm:py-2.5 transition-colors inline-flex items-center gap-1.5 sm:gap-2"
              >
                <span className="text-xs text-[#999]">{item.before}</span>
                <ArrowRight className="w-3 h-3 text-[#ccc]" />
                <span className="text-xs sm:text-sm text-[#0A0A0A] font-semibold">{item.after}</span>
              </motion.div>
            ))}
          </div>
