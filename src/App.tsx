...
import { FAQSection, FloatingCTA, PurchaseModal } from './components/sections';
  ...
  const testimonials = [
    {
      name: "Андрей",
      studio: "Москва",
      text: "Клиент приехал на оклейку зон риска (65 000₽). В итоге продал допы и закрыл на 150 000₽. Клиент довольный как слон. Я тоже",
      rating: 5
    },
    {
      name: "Артем",
      studio: "Санкт-Петербург",
      text: "Изначальный запрос - зоны риска 75 000₽. Итоговый чек - 195 000₽, допродал по вашей схеме до оклейки вкруг.",
      rating: 5
    },
    {
      name: "Сергей",
    ...
    },
    {
      name: "Ирина",
      studio: "Калуга",
      text: "Сделала допродажу антихрома на 30 000₽. Неожидала, что это будет так просто!",
      rating: 5
    },
    {
      name: "Владимир",
      studio: "Краснодар",
      text: "Раньше теряли половину звонков. Теперь регулярно закрываем 8 из 10 на мойку благодаря техникам из интенсива.",
      rating: 5
    },
    {
      name: "Игорь",
      studio: "Самара",
      text: "Стал продавать увереннее, клиенты чаще стали соглашаться на приезд в студию. Хотя раньше даже смс игнорили. Работы стало больше.",
      rating: 5
    },
    {
      name: "Павел",
      studio: "Ростов-на-Дону",
      text: "Интересно было послушать опыт Валерия, вдохновился очень его масштабами.",
      rating: 5
    },
    {
      name: "Андрей",
      studio: "Уфа",
      text: "После обучения команда стала увереннее работать с возражениями. Прибыль выросла на 55% за месяц!!.",
      rating: 5
    },
    {
      name: "Максим",
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              { before: "Работа «ради работы»", after: "Растите средний чек на 40–100 %" },
              { before: "Полируете машину за базовый прайс, боясь предложить больше", after: "Внедряете скрипты допродаж и с одной машины зарабатываете как с двух, не вкладываясь в рекламу" },
              { before: "Сливаете 8 из 10 звонков", after: "Закрываете 7 из 10 в запись" },
              { before: "Клиент узнает цену и пропадает", after: "Берете инициативу в свои руки за 30 секунд и ведете клиента по воронке к визиту, а не к «я подумаю»" },
              { before: "Минус 15–20% прибыли на скидках", after: "Продаете за 100% прайса" },
              { before: "Даете скидку первым, чтобы удержать клиента", after: "Владеете аргументами, которые обосновывают стоимость. Скидки даете только тогда, когда это выгодно вам" },
              { before: "Боязнь высоких чеков", after: "Спокойствие при чеках 500 000+" },
              { before: "Клиент-одноразка", after: "Рост базы постоянных клиентов" },
              { before: "Клиент сделал услугу и забыл про вас. Вы каждый раз тратите деньги на поиск новых", after: "Клиент возвращается строго по графику на коррекцию и уход, потому что вы «подсадили» его на сервис и заботу" }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 10 }}
