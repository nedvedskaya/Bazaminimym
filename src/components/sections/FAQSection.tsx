...
const faqItems = [
  {
    ...
    a: "Уроки длятся 10–15 минут. Весь интенсив можно изучить за 2–3 часа."
  },
  {
    q: "Подойдет ли новичку?",
    a: "Да! Системы продаж разработаны так, что разберется и владелец студии, и новичок-менеджер. Стартуем с основ и сразу в практику."
  },
  {
  ...
  },
  {
    ...
    a: "Доступ открывается автоматически после оплаты. Ссылка на тг-канал обучения придет на почту. Никаких сложных платформ и паролей — все материалы у вас под рукой 24/7."
  }
];
